        ...
        <div className="new__invoice-body">
          ...
          <div className="bill__to">
            ...
            <div className="form__group inline__form-group">
              ...
              <div className="inline__group">
                <p>Phone number with Country Code(without space)</p>
                <input
                  type="text"
                  value={paymentTerms}
...
export async function getStaticProps(context) {
  ...
  const client = await MongoClient.connect(
    "mongodb+srv://inadmin:adminpass@invoice1.jgk5yn8.mongodb.net/invoices1?retryWrites=true&w=majority",{ useNewUrlParser: true }
  );
